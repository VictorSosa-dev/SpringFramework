...
import com.bolsadeideas.springboot.error.app.service.UsuarioService;
...
public class AppControlller {
	...
	public String ver(@PathVariable Integer id, Model model) throws UsuarioNoEncontradoException {
		/*
		Usuario usuario = usuarioService.obtnerPorId(id);
		if (usuario == null) {
			throw new UsuarioNoEncontradoException(id.toString());
		}
		*/
		
		Usuario usuario = usuarioService.obtnerPorIdOptional(id).orElseThrow(() -> new UsuarioNoEncontradoException(id.toString()));
